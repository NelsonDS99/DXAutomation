...
public class InputDialog extends BasicDX
{
  ...
  {
    String[] options = workbookOption(folder);
    ImageIcon icon1 = new ImageIcon("C:\\Users\\nelson.scott\\gitDx\\GeneXpertUiAuto\\png\\infinity.png");
  ...
  public String selectFolder ()
  {
    String[] options = { "D6780 Customize Test Result", "D6781 Organism-Based Results", "D8380 Probe Check",
        "D8383 Background Subtraction and Crosstalk Correction", "D8384 Percent Ratio", "D27345 Organism Based Omni Results" };
    ImageIcon icon2 = new ImageIcon("C:\\Users\\nelson.scott\\gitDx\\GeneXpertUiAuto\\png\\cart.png");
  ...
  public String selectSheet (String document)
  {
    ...
    switch (folder) {
      ...
      case "D6781 Organism-Based Results":
        ...
        break;
      case "D27345 Organism Based Omni Results":
        sheet = "AllTestResults";
        break;
    }
  ...
  /*
   * If program doesn't use the input dialog class, returns the folder as extra
   * Otherwise returns the name of the folder the verification is associated with
   */
   ...
   */
  private String[] workbookOption (String folder)
  {
    String[] files = null;
    switch (folder) {
      case "D6780 Customize Test Result":
      ...
      case "D8384 Percent Ratio":
        ...
        break;
      case "D27345 Organism Based Omni Results":
        files = new String[] { "D27345 Basic Organism Based Test Results Verification",
            "D27345 CTNG Test Results Verification", "D27345 Delta Ct Organism Test Results Verification",
            "D27345 Organism Type Combination Test Results Verification",
            "D27345 Semi-quantitative Organism Test Results Verification" };
        break;
    }
    return files;
  }
  ...
  /*
   * The input dialog for choosing the correct sheet
   */
  private String sheetOption (String[] options)
  {
    ImageIcon icon3 = new ImageIcon("C:\\Users\\nelson.scott\\gitDx\\GeneXpertUiAuto\\png\\disc.png");
