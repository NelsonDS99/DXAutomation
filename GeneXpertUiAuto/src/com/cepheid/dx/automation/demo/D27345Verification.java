...
public class D27345Verification extends VerifyResultMethods
{
  
  public void BasicOrganismBasedOmniResultsVerification (String folder, String document, String workSheet)
  {
  ...
  @Test
  public void D27345_BasicOrganismBasedTestResults_AllTestResults()
  {
    BasicOrganismBasedOmniResultsVerification("D27345 Organism Based Omni Results", "D27345 Basic Organism Based Test Results Verification","AllTestResults");
    resetMap();
    resetHtml();
  }
  
  @Test
  public void D27345_CTNGTestResultsVerification_AllTestResults()
  {
    BasicOrganismBasedOmniResultsVerification("D27345 Organism Based Omni Results", "D27345 CTNG Test Results Verification","AllTestResults");
    resetMap();
    resetHtml();
  ...
  @Test
  public void D27345_DeltaCtOrganismTestResultsVerification_AllTestResults()
  {
    BasicOrganismBasedOmniResultsVerification("D27345 Organism Based Omni Results", "D27345 Delta Ct Organism Test Results Verification","AllTestResults");
    resetMap();
    resetHtml();
  }
  
  @Test
  public void D27345_OrganismTypeCombinationTestResultsVerification_AllTestResults()
  {
    BasicOrganismBasedOmniResultsVerification("D27345 Organism Based Omni Results", "D27345 Organism Type Combination Test Results Verification","AllTestResults");
    resetMap();
    resetHtml();
  }
  
  @Test
  public void D27345_SemiQuantitativeTestResultsVerification_AllTestResults()
  {
    BasicOrganismBasedOmniResultsVerification("D27345 Organism Based Omni Results", "D27345 Semi-quantitative Organism Test Results Verification","AllTestResults");
    resetMap();
    resetHtml();
  }
