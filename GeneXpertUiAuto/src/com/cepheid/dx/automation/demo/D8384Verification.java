...
public class D8384Verification extends VerifyResultMethods
{

  public void PercentRatioVerification (String folder, String document, String workSheet)
  {
  ...
  @Test
  public void D8384_VerifyD8384_LSP()
  {
    PercentRatioVerification("D8384 Percent Ratio", "VerifyD8384", "LSP");
    resetMap();
    resetHtml();
  }
  
  @Test
  public void D8384_VerifyD8384_PercentRatio()
  {
    PercentRatioVerification("D8384 Percent Ratio", "VerifyD8384", "PercentRatio"); 
    resetMap();
    resetHtml();
  }
}