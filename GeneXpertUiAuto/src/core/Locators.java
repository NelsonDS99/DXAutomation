...
public class Locators extends BasicDX
{
  ...
  protected final String PASSWORD_BOX                 = "/JDialog[@caption='Login']//JPasswordField[@priorlabel='Password']";
  protected final String LOGIN_OK_BTN                 = "/JDialog[@caption='Login']//JButton[@caption='OK']";
